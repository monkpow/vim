...
exec "hi StatusLine     cterm=NONE   ctermfg=" . <SID>X("81") . "   ctermbg=" . <SID>X(79) . ""
exec "hi StatusLineNC   cterm=NONE   ctermfg=" . <SID>X("88") . "   ctermbg=" . <SID>X(83) . ""
...
exec "hi Title          ctermfg=" . <SID>X("85") . "   ctermbg=" . <SID>X(80) . ""
exec "hi Visual         cterm=NONE   ctermfg=" . <SID>X("80") . "   ctermbg=" . <SID>X(73) . ""

exec "hi Comment        cterm=NONE   ctermfg=" . <SID>X("82") . "   ctermbg=NONE"
exec "hi Constant       cterm=NONE   ctermfg=" . <SID>X("73") . "   ctermbg=NONE"
exec "hi String         cterm=NONE   ctermfg=" . <SID>X("86") . "   ctermbg=NONE" 
"    exec "hi String         cterm=NONE   ctermfg=" . <SID>X("73") . "   ctermbg=" . <SID>X(8) . ""
exec "hi Error          cterm=NONE   ctermfg=" . <SID>X("79") . "   ctermbg=" . <SID>X(64) . ""
exec "hi Identifier     cterm=NONE   ctermfg=" . <SID>X("29") . "   ctermbg=NONE"
...
exec "hi Special        cterm=NONE   ctermfg=" . <SID>X("53") . "   ctermbg=NONE"
exec "hi Statement      cterm=NONE   ctermfg=" . <SID>X("78") . "   ctermbg=NONE"
...
exec "hi VertSplit      cterm=BOLD   ctermfg=" . <SID>X("81") . "   ctermbg=" . <SID>X(81) . ""
" color the popup menu
exec "hi Pmenu          cterm=BOLD   ctermfg=" . <SID>X("26") . "   ctermbg=" . <SID>X(81) . ""
exec "hi PmenuSel       cterm=BOLD   ctermfg=" . <SID>X("10") . "   ctermbg=" . <SID>X(81) . ""
